...
if(PDF_EXPORT){
  ...
  cat("[<i class='fas fa-download'></i> Download a PDF of this CV](https://github.com/francisko-rezende/cv/raw/master/de_moraes_rezende-cv.pdf)")
}
```
...
::: aside
Being part of diverse research groups was a privilege. Cooperation is invaluable when it comes to scientific production. 
:::
